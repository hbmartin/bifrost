...
function getProviderAzureClient(
  ...
  describe("Streaming Chat - Client Disconnect", () => {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        console.log(
          `[Azure] Streaming client disconnect passed for ${model} (${chunkCount} chunks before abort)`,
        );
      },
    );
  });
  ...
  describe("Embeddings - Similarity Analysis", () => {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        console.log(
          `[Azure] Embedding similarity analysis passed for ${model} (similarity: ${similarity.toFixed(3)})`,
        );
      },
    );
  });
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          if (isApiNotSupportedError(error)) {
            console.log(
              `[Azure] Responses API test skipped (API not supported): ${error instanceof Error ? error.message : "Unknown error"}`,
            );
          } else {
            throw error;
          }
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          if (isApiNotSupportedError(error)) {
            console.log(
              `[Azure] Responses API with system message test skipped (API not supported): ${error instanceof Error ? error.message : "Unknown error"}`,
            );
          } else {
            throw error;
          }
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          if (isApiNotSupportedError(error)) {
            console.log(
              `[Azure] Responses API with image test skipped (API not supported): ${error instanceof Error ? error.message : "Unknown error"}`,
            );
          } else {
            throw error;
          }
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          if (isApiNotSupportedError(error)) {
            console.log(
              `[Azure] Responses API with tools test skipped (API not supported): ${error instanceof Error ? error.message : "Unknown error"}`,
            );
          } else {
            throw error;
          }
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          if (isApiNotSupportedError(error)) {
            console.log(
              `[Azure] Responses API streaming test skipped (API not supported): ${error instanceof Error ? error.message : "Unknown error"}`,
            );
          } else {
            throw error;
          }
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          expect(wasAborted || abortController.signal.aborted).toBe(true);
          console.log(
            `[Azure] Responses API streaming client disconnect passed for ${model} (${chunkCount} chunks before abort)`,
          );
        } catch (error) {
          if (isApiNotSupportedError(error)) {
            console.log(
              `[Azure] Responses API streaming client disconnect test skipped (API not supported): ${error instanceof Error ? error.message : "Unknown error"}`,
            );
          } else {
            throw error;
          }
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          expect(chunkCount).toBeGreaterThan(1);
          console.log(
            `[Azure] Responses API streaming with tools passed for ${model} (tool call: ${hasToolCall})`,
          );
        } catch (error) {
          if (isApiNotSupportedError(error)) {
            console.log(
              `[Azure] Responses API streaming with tools test skipped (API not supported): ${error instanceof Error ? error.message : "Unknown error"}`,
            );
          } else {
            throw error;
          }
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          if (isApiNotSupportedError(error)) {
            console.log(
              `[Azure] Responses API reasoning test skipped (API not supported): ${error instanceof Error ? error.message : "Unknown error"}`,
            );
          } else {
            throw error;
          }
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          if (isApiNotSupportedError(error)) {
            console.log(
              `[Azure] Image generation test skipped (API not supported): ${error instanceof Error ? error.message : "Unknown error"}`,
            );
          } else {
            throw error;
          }
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          console.log(
            `[Azure] Input tokens count passed for ${model} (${response.total_tokens} tokens)`,
          );
        } catch (error) {
          if (isApiNotSupportedError(error)) {
            console.log(
              `[Azure] Input tokens count test skipped (API not supported): ${error instanceof Error ? error.message : "Unknown error"}`,
            );
          } else {
            throw error;
          }
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          expect(response.total_tokens).toBeGreaterThan(0);
          console.log(
            `[Azure] Input tokens with system message passed for ${model} (${response.total_tokens} tokens)`,
          );
        } catch (error) {
          if (isApiNotSupportedError(error)) {
            console.log(
              `[Azure] Input tokens with system message test skipped (API not supported): ${error instanceof Error ? error.message : "Unknown error"}`,
            );
          } else {
            throw error;
          }
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          console.log(
            `[Azure] Input tokens long text passed for ${model} (${response.total_tokens} tokens)`,
          );
        } catch (error) {
          if (isApiNotSupportedError(error)) {
            console.log(
              `[Azure] Input tokens long text test skipped (API not supported): ${error instanceof Error ? error.message : "Unknown error"}`,
            );
          } else {
            throw error;
          }
