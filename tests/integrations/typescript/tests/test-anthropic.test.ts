...
function convertToAnthropicMessages(messages: ChatMessage[]): Anthropic.MessageParam[] {
...
describe("Anthropic SDK Integration Tests", () => {
  ...
  describe("Streaming Chat - Client Disconnect", () => {
    it("should handle client disconnect mid-stream", async () => {
          ...
          messages: [
            {
              role: "user",
              content:
                "Write a detailed essay about the history of computing, including at least 10 paragraphs.",
            },
          ],
        },
        {
      ...
      console.log(
        `✅ Streaming client disconnect passed for anthropic/${model} (${chunkCount} chunks before abort)`,
      );
    });
  });
  ...
  describe("Thinking/Extended Reasoning", () => {
    it("should support extended thinking", async () => {
      ...
      try {
        ...
        const hasThinking = response.content.some(
        ...
        console.log(
          `⚠️ Thinking test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Prompt Caching - System Message", () => {
    it("should support prompt caching with system message", async () => {
      ...
      const response1 = await client.messages.create({
        ...
        messages: [{ role: "user", content: "What are the key elements of contract formation?" }],
      } as never);
      ...
      const response2 = await client.messages.create({
        ...
        messages: [{ role: "user", content: "Explain the purpose of force majeure clauses." }],
      } as never);
  ...
  describe("Document Input - PDF Base64", () => {
    it("should handle PDF document input", async () => {
      ...
      try {
        ...
        console.log(
          `⚠️ Document input test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
    ...
    it("should list available models", async () => {
      ...
      try {
        ...
        const response = await (
          client as unknown as { models: { list: () => Promise<{ data: unknown[] }> } }
        ).models.list();
        ...
        console.log(
          `⚠️ List models test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Extended Thinking Streaming", () => {
    it("should stream extended thinking response", async () => {
      ...
      try {
          ...
          messages: [
            {
              role: "user",
              content:
                "Alice, Bob, and Carol went to dinner. The total bill was $90. If they split it equally, how much does each person owe? Show your reasoning.",
            },
          ],
        } as never);
        ...
        console.log(
          `✅ Extended thinking streaming passed for anthropic/${model} (${chunkCount} chunks)`,
        );
      } catch (error) {
        console.log(
          `⚠️ Extended thinking streaming test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Extended Thinking Streaming - Client Disconnect", () => {
    it("should handle client disconnect mid-stream during extended thinking", async () => {
      ...
      try {
            ...
            messages: [
              {
                role: "user",
                content:
                  "Solve this complex problem step by step: A train leaves Station A at 8:00 AM traveling at 60 mph. Another train leaves Station B, 300 miles away, at 9:00 AM traveling toward Station A at 80 mph. At what time will they meet? Show all your detailed reasoning.",
              },
            ],
          } as never,
          {
        ...
        expect(wasAborted).toBe(true);
        console.log(
          `✅ Extended thinking streaming client disconnect passed for anthropic/${model} (${chunkCount} chunks before abort)`,
        );
      } catch (error) {
        console.log(
          `⚠️ Extended thinking streaming disconnect test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
    ...
    it("should upload a file", async () => {
      ...
      try {
        ...
        const testContent = new TextEncoder().encode(
          "This is a test file for Files API integration testing.",
        );
        ...
        try {
          const betaFiles = (
            client as unknown as { beta: { files: { delete: (id: string) => Promise<void> } } }
          ).beta;
        ...
        console.log(
          `⚠️ Files API upload test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Files API - List", () => {
    it("should list files", async () => {
      ...
      try {
        ...
        console.log(
          `⚠️ Files API list test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Files API - Delete", () => {
    it("should delete a file", async () => {
      ...
      try {
        ...
        console.log(
          `⚠️ Files API delete test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
    ...
    it("should download file content", async () => {
      ...
      try {
        ...
        try {
          ...
          console.log(
            `✅ Files API content passed for anthropic - Downloaded ${downloadedContent.length} bytes`,
          );
        } catch (downloadError) {
          // Some providers don't allow downloading uploaded files
          console.log(
            `⚠️ Files API download not supported: ${downloadError instanceof Error ? downloadError.message : "Unknown error"}`,
          );
        } finally {
          try {
            await beta.files.delete(uploadedFile.id);
        ...
        console.log(
          `⚠️ Files API content test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Batch API - Create Inline", () => {
    it("should create a batch job with inline requests", async () => {
      ...
      try {
        ...
        console.log(
          `✅ Batch API create inline passed for anthropic - Batch ID: ${batch.id}, Status: ${batch.processing_status}`,
        );
        ...
        console.log(
          `⚠️ Batch API create inline test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Batch API - List", () => {
    it("should list batch jobs", async () => {
      ...
      try {
        ...
        console.log(
          `⚠️ Batch API list test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
    ...
    it("should retrieve batch status by ID", async () => {
      ...
      try {
        ...
        try {
          ...
          console.log(
            `✅ Batch API retrieve passed for anthropic - Batch ID: ${retrieved.id}, Status: ${retrieved.processing_status}`,
          );
        } finally {
          try {
            await beta.messages.batches.cancel(batch.id);
        ...
        console.log(
          `⚠️ Batch API retrieve test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Batch API - Cancel", () => {
    it("should cancel a batch job", async () => {
      ...
      try {
        ...
        console.log(
          `✅ Batch API cancel passed for anthropic - Batch ID: ${cancelled.id}, Status: ${cancelled.processing_status}`,
        );
      } catch (error) {
        console.log(
          `⚠️ Batch API cancel test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
    ...
    it("should retrieve batch results", async () => {
      ...
      try {
        ...
        try {
          ...
          console.log(
            `⚠️ Batch results not ready: ${resultsError instanceof Error ? resultsError.message : "Unknown error"}`,
          );
        } finally {
          try {
            await beta.messages.batches.cancel(batch.id);
        ...
        console.log(
          `⚠️ Batch API results test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Batch API - E2E", () => {
    it("should complete end-to-end batch workflow", async () => {
      ...
      try {
        ...
        console.log(
          `⚠️ Batch API E2E test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Count Tokens - With System Message", () => {
    it("should return token usage with system message", async () => {
      ...
      expect(response.usage.output_tokens).toBeGreaterThan(0);
      console.log(
        `✅ Count tokens with system message passed for anthropic/${model} (input: ${response.usage.input_tokens}, output: ${response.usage.output_tokens})`,
      );
    });
  });
  ...
  describe("Count Tokens - Long Text", () => {
    it("should return token usage for long text", async () => {
      ...
      const longText =
        "This is a longer piece of text that should result in more tokens being counted. ".repeat(
          10,
        );
      ...
      expect(response.usage.output_tokens).toBeGreaterThan(0);
      console.log(
        `✅ Count tokens long text passed for anthropic/${model} (input: ${response.usage.input_tokens}, output: ${response.usage.output_tokens})`,
      );
    });
  });
  ...
  describe("Document Input - Plain Text", () => {
    it("should handle plain text document input", async () => {
      ...
      try {
        ...
        console.log(
          `⚠️ Document input (plain text) test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Citations - PDF Document", () => {
    it("should return PDF citations with page_location", async () => {
      ...
      const document = createAnthropicDocument(FILE_DATA_BASE64, "pdf", "Test PDF Document");
      ...
      try {
        ...
        for (const block of response.content) {
          if ((block as unknown as { citations?: AnthropicCitation[] }).citations) {
            ...
            for (const citation of citations) {
              ...
              const pageCitation = citation as {
        ...
        console.log(
          `⚠️ PDF citations test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Citations - Text Document", () => {
    it("should return text citations with char_location", async () => {
      ...
      try {
        ...
        for (const block of response.content) {
          if ((block as unknown as { citations?: AnthropicCitation[] }).citations) {
            ...
            for (const citation of citations) {
              ...
              const charCitation = citation as {
        ...
        console.log(
          `⚠️ Text citations test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Citations - Multi Document", () => {
    it("should return citations from multiple documents with document_index validation", async () => {
      ...
      try {
        ...
        console.log(
          `⚠️ Multi-document citations test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Citations - Streaming Text", () => {
    it("should stream text citations with citations_delta", async () => {
      ...
      try {
        ...
        console.log(
          `✓ Streaming citations test passed - ${citations.length} citations in ${chunkCount} chunks`,
        );
      } catch (error) {
        console.log(
          `⚠️ Streaming citations test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Citations - Streaming PDF", () => {
    it("should stream PDF citations with page_location", async () => {
      ...
      try {
        ...
        console.log(
          `✓ Streaming PDF citations test passed - ${citations.length} citations in ${chunkCount} chunks`,
        );
      } catch (error) {
        console.log(
          `⚠️ Streaming PDF citations test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
    ...
    it("should perform web search and return citations", async () => {
      ...
      try {
        ...
        for (const block of response.content) {
          ...
          if (
            blockObj.type === "server_tool_use" &&
            (blockObj as { name?: string }).name === "web_search"
          ) {
            hasWebSearch = true;
        ...
        console.log(
          `⚠️ Web search non-streaming test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Web Search - Streaming", () => {
    it("should stream web search results", async () => {
      ...
      try {
        ...
        console.log(
          `⚠️ Web search streaming test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
