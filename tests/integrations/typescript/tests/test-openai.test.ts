...
import { getIntegrationUrl, getProviderModel, getVirtualKey } from "../src/utils/config-loader";
  ...
  describe("Multi-turn Conversation", () => {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        const response = await client.chat.completions.create({
          ...
          messages: convertMessages([
            ...MULTI_TURN_MESSAGES.slice(0, -1),
            {
              role: "user",
              content:
                "What is the population of that city? Include the city name and the word population in your answer.",
            },
          ]),
          max_tokens: 100,
        });
        ...
        console.log(
          `✅ Multi-turn conversation passed for ${formatProviderModel(provider, model)}`,
        );
      },
    );
  });
  ...
  describe("Streaming Chat - Client Disconnect", () => {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        console.log(
          `✅ Streaming client disconnect passed for ${formatProviderModel(provider, model)} (${chunkCount} chunks before abort)`,
        );
      },
    );
  });
  ...
  describe("Multiple Tool Calls", () => {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        expect(
          toolNames.some((name: string) => name === "get_weather" || name === "calculate"),
        ).toBe(true);
  ...
  describe("End-to-End Tool Calling", () => {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        console.log(
          `✅ End-to-end tool calling passed for ${formatProviderModel(provider, model)}`,
        );
      },
    );
  });
  ...
  describe("Multiple Images", () => {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        assertValidImageResponse(response);
        console.log(
          `✅ Multiple images analysis passed for ${formatProviderModel(provider, model)}`,
        );
      },
    );
  });
  ...
  describe("Embeddings - Similarity Analysis", () => {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        console.log(
          `✅ Embedding similarity analysis passed for ${formatProviderModel(provider, model)} (similarity: ${similarity.toFixed(3)})`,
        );
      },
    );
  });
  ...
  describe("List Models", () => {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        console.log(
          `✅ List models passed for ${formatProviderModel(provider, model)} (${models.data.length} models)`,
        );
      },
    );
  });
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          console.log(
            `✅ File upload passed for ${formatProviderModel(provider, model)} - File ID: ${response.id}`,
          );
        } finally {
          // Clean up
          if (uploadedFileId) {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          console.log(
            `✅ File list passed for ${formatProviderModel(provider, model)} - ${response.data.length} files`,
          );
        } finally {
          // Clean up
          if (uploadedFileId) {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          console.log(
            `✅ File retrieve passed for ${formatProviderModel(provider, model)} - File ID: ${response.id}`,
          );
        } finally {
          // Clean up
          if (uploadedFileId) {
  ...
  describe("Files API - Delete", () => {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        console.log(
          `✅ File delete passed for ${formatProviderModel(provider, model)} - File ID: ${response.id}`,
        );
      },
    );
  });
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          console.log(
            `✅ Batch create passed for ${formatProviderModel(provider, model)} - Batch ID: ${batch.id}`,
          );
        } finally {
          // Clean up batch
          if (batchId) {
  ...
  describe("Batch API - List", () => {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        console.log(
          `✅ Batch list passed for ${formatProviderModel(provider, model)} - ${response.data.length} batches`,
        );
      },
    );
  });
  ...
  describe("Batch API - Retrieve", () => {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        console.log(
          `✅ Batch retrieve passed for ${formatProviderModel(provider, model)} - Batch ID: ${response.id}, Status: ${response.status}`,
        );
      },
    );
  });
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          console.log(
            `✅ Batch cancel passed for ${formatProviderModel(provider, model)} - Batch ID: ${response.id}, Status: ${response.status}`,
          );
        } finally {
          // Clean up file
          if (uploadedFileId) {
  ...
  describe("Responses API - Simple Text", () => {
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        const responses = (
          client as unknown as { responses: { create: (params: unknown) => Promise<unknown> } }
        ).responses;
        ...
        try {
          ...
          console.log(
            `✅ Responses API simple text passed for ${formatProviderModel(provider, model)}`,
          );
        } catch (error) {
          console.log(
            `⚠️ Responses API test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          expect(content.length).toBeGreaterThan(20);
          console.log(
            `✅ Responses API with system message passed for ${formatProviderModel(provider, model)}`,
          );
        } catch (error) {
          console.log(
            `⚠️ Responses API with system message test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          expect(content.length).toBeGreaterThan(20);
          console.log(
            `✅ Responses API with image passed for ${formatProviderModel(provider, model)}`,
          );
        } catch (error) {
          console.log(
            `⚠️ Responses API with image test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          console.log(
            `✅ Responses API with tools passed for ${formatProviderModel(provider, model)}`,
          );
        } catch (error) {
          console.log(
            `⚠️ Responses API with tools test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        const responses = (
          client as unknown as {
            responses: { create: (params: unknown) => Promise<AsyncIterable<unknown>> };
          }
        ).responses;
        ...
        try {
          ...
          expect(content.length).toBeGreaterThan(0);
          console.log(
            `✅ Responses API streaming passed for ${formatProviderModel(provider, model)} (${chunkCount} chunks)`,
          );
        } catch (error) {
          console.log(
            `⚠️ Responses API streaming test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          const stream = await responses.create(
            {
              model: formatProviderModel(provider, model),
              input:
                "Write a detailed essay about the history of artificial intelligence, including at least 10 paragraphs covering different eras and breakthroughs.",
          ...
          expect(abortController.signal.aborted).toBe(true);
          console.log(
            `✅ Responses API streaming client disconnect passed for ${formatProviderModel(provider, model)} (${chunkCount} chunks before abort)`,
          );
        } catch (error) {
          console.log(
            `⚠️ Responses API streaming client disconnect test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          const stream = await responses.create({
            model: formatProviderModel(provider, toolModel || model),
            input: [{ type: "input_text", text: "What's the weather in San Francisco?" }],
            tools,
            max_output_tokens: 150,
            stream: true,
          });
          ...
          expect(chunkCount).toBeGreaterThan(1);
          console.log(
            `✅ Responses API streaming with tools passed for ${formatProviderModel(provider, model)} (tool call: ${hasToolCall})`,
          );
        } catch (error) {
          console.log(
            `⚠️ Responses API streaming with tools test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          console.log(
            `✅ Responses API reasoning passed for ${formatProviderModel(provider, model)}`,
          );
        } catch (error) {
          console.log(
            `⚠️ Responses API reasoning test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          const responses = (
            client as unknown as {
              responses: {
                input_tokens: { count: (params: unknown) => Promise<{ total_tokens: number }> };
              };
            }
          ).responses;
          ...
          console.log(
            `✅ Input tokens count passed for ${formatProviderModel(provider, model)} (${response.total_tokens} tokens)`,
          );
        } catch (error) {
          console.log(
            `⚠️ Input tokens count test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          expect(response.total_tokens).toBeGreaterThan(0);
          console.log(
            `✅ Input tokens with system message passed for ${formatProviderModel(provider, model)} (${response.total_tokens} tokens)`,
          );
        } catch (error) {
          console.log(
            `⚠️ Input tokens with system message test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          console.log(
            `✅ Input tokens long text passed for ${formatProviderModel(provider, model)} (${response.total_tokens} tokens)`,
          );
        } catch (error) {
          console.log(
            `⚠️ Input tokens long text test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          console.log(
            `⚠️ Web search annotation conversion test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          console.log(
            `⚠️ Web search user location test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          console.log(
            `⚠️ Web search wildcard domains test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    it.each(testCases)(
      ...
      async ({ provider, model, vkEnabled }: ProviderModelVkParam) => {
        ...
        try {
          ...
          console.log(
            `⚠️ Web search multi-turn test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
