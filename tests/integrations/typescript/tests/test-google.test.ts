...
import { getProviderModel, isProviderAvailable } from "../src/utils/config-loader";
  ...
  describe("Multi-turn Conversation", () => {
    it("should handle multi-turn conversation", async () => {
      ...
      const result = await chat.sendMessage(
        MULTI_TURN_MESSAGES[MULTI_TURN_MESSAGES.length - 1].content as string,
      );
  ...
  describe("Streaming Chat", () => {
    it("should stream chat response", async () => {
      ...
      const result = await model.generateContentStream(
        STREAMING_CHAT_MESSAGES[0].content as string,
      );
  ...
  describe("Embeddings - Batch", () => {
    it("should generate batch embeddings", async () => {
      ...
      const result = await model.batchEmbedContents({
        requests: EMBEDDINGS_MULTIPLE_TEXTS.map((text) => ({
  ...
  describe("Audio Transcription", () => {
    it("should transcribe audio content", async () => {
      ...
      try {
        ...
        console.log(
          `⚠️ Transcription test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Speech Synthesis", () => {
    it("should synthesize speech", async () => {
      ...
      try {
        ...
        console.log(
          `⚠️ Speech synthesis test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("System Instruction", () => {
    it("should respect system instructions", async () => {
      ...
      try {
        ...
        console.log(
          `⚠️ System instruction test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
  ...
  describe("Structured Output", () => {
    it("should generate structured output with JSON schema", async () => {
      ...
      try {
          ...
          contents: [
            {
              ...
              parts: [
                {
                  text: "Give me a recipe for chocolate chip cookies as JSON with name, ingredients (array), and instructions (array).",
                },
              ],
            },
          ],
        ...
        console.log(
          `⚠️ Structured output test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
        );
      }
    });
  });
