  ...
  describe("LangChain OpenAI", () => {
    ...
    describe("Streaming Chat - Client Disconnect", () => {
      it("should handle client disconnect mid-stream", async () => {
        ...
        console.log(
          `✅ LangChain OpenAI streaming client disconnect passed (${chunkCount} chunks before abort)`,
        );
      });
    });
  ...
  describe("LangChain Anthropic", () => {
    ...
    describe("Streaming Chat - Client Disconnect", () => {
      it("should handle client disconnect mid-stream", async () => {
        ...
        expect(wasAborted).toBe(true);
        console.log(
          `✅ LangChain Anthropic streaming client disconnect passed (${chunkCount} chunks before abort)`,
        );
      });
    });
    ...
    describe("Structured Output", () => {
      it("should generate structured output", async () => {
        ...
        try {
          ...
          console.log(
            `⚠️ LangChain Google GenAI structured output test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      });
    });
    ...
    describe("Anthropic Complex Structured Output", () => {
      ...
      it("should generate complex structured output", async () => {
        ...
        try {
          ...
          console.log(
            `⚠️ LangChain Anthropic complex structured output test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      });
    });
    ...
    describe("OpenAI Thinking", () => {
      ...
      it("should support extended reasoning", async () => {
        ...
        try {
          ...
          console.log(
            `⚠️ LangChain OpenAI thinking test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      });
    });
    ...
    describe("Anthropic Thinking", () => {
      ...
      it("should support extended reasoning", async () => {
        ...
        try {
          ...
          console.log(
            `⚠️ LangChain Anthropic thinking test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      });
    });
    ...
    describe("Google GenAI Thinking", () => {
      ...
      it("should support extended reasoning", async () => {
        ...
        try {
          ...
          console.log(
            `⚠️ LangChain Google GenAI thinking test skipped: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      });
    });
  ...
  describe("Streaming Tool Calls", () => {
    describe("OpenAI Streaming Tool Calls", () => {
      ...
      it("should stream tool calls", async () => {
        ...
        console.log(
          `✅ LangChain OpenAI streaming tool calls passed (tool call detected: ${hasToolCall})`,
        );
      });
    });
  });
