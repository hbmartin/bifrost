...
export class MCPSettingsPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.maxAgentDepthInput = page
      .getByTestId("mcp-agent-depth-input")
      .or(page.locator("#mcp-agent-depth"));
    this.toolTimeoutInput = page
      .getByTestId("mcp-tool-timeout-input")
      .or(page.locator("#mcp-tool-execution-timeout"));
  }
