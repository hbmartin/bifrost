 ...
 */
export function createOtelConnectorData(
  overrides: Partial<ObservabilityConnectorConfig> = {},
): ObservabilityConnectorConfig {
  return {
    type: "otel",
    enabled: true,
 ...
 */
export function createMaximConnectorData(
  overrides: Partial<ObservabilityConnectorConfig> = {},
): ObservabilityConnectorConfig {
  return {
    type: "maxim",
