...
- **Raw base64 normalization**: Recognized JPEG, PNG, GIF, WebP, BMP, and SVG payloads are converted to data URLs; unknown payloads are rejected instead of being mislabeled as JPEG
