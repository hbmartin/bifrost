...
| **Usage & cost** | `gen_ai.usage.input_tokens`, `gen_ai.usage.output_tokens`, `gen_ai.usage.cost` |
| **Bifrost context** | `bifrost.virtual_key.id`, `bifrost.team.id`, `bifrost.customer.id`, `bifrost.retries` |
