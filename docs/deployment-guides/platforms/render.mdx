...
Until then, copy this repository's root `render.yaml` into your own repository, then create and approve a Render Blueprint from that repository.
</Warning>
...
Until then, copy `deploy/render/render-sqlite.yaml` into your own repository as the root `render.yaml`, then create a Render Blueprint from it.
</Warning>
