...
{/*
  ...
  requires this page to regain an H2 section titled "Hosted one-click choices"
  listing the published buttons. The removed comparison table to restore lives in
  git history: `git show 4da6e0c82~1:docs/deployment-guides/overview.mdx`.
